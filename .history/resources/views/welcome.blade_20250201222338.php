...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light sticky-top " style="background-color: rgba(11, 11, 11, 0.9);">
    <a class="navbar-brand" href="#">
      <img src="{{ asset('img/logopa.jpg') }}" width="80" height="80" class="d-inline-block align-top" alt="Votre Logo">
    </a>
...
<!-- Section GPA (Gestion de Projet Agile) -->
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <div class="d-flex">
                ...
                <img src="img/logopa.jpg" alt="Logo GPA" class="img-fluid rounded-circle" style="width: 140px; height: 140px; left: -150px; top: 38px;">

                <!-- Contenu de la description -->
                <div>
                    <h2 style="font-family: Georgia, serif;">
                        Bienvenue au <span class="font-weight-bold" style="color:#e16db3;">GPA:</span>
                    </h2>
                    <p style="text-align: justify;">
                        La clé pour des projets innovants, flexibles et efficaces. Avec des cycles de livraison rapides, une collaboration renforcée et une adaptation continue, GPA transforme vos défis en succès. Découvrez comment notre approche Agile sur mesure peut propulser vos résultats.
                    </p>
                </div>
            </div>
        </div>

        <!-- Colonne du carrousel -->
            ...
            <div id="carouselControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" style="border-start-start-radius: 225px;">
                    ...
                    <div class="carousel-item active">
                        <img src="img/agile-team.jpg" class="d-block w-100" alt="Équipe Agile" style="height: 400px;">
                        <div class="carousel-caption">
                            <h2>Équipes Agile</h2>
                            <p>Découvrez comment nos équipes collaboratives travaillent ensemble pour atteindre des objectifs communs.</p>
                        </div>
                    </div>
                    <!-- Slide 2 -->
                    <div class="carousel-item">
                        <img src="img/kanban-board.jpg" class="d-block w-100" alt="Tableau Kanban" style="height: 400px;">
                        <div class="carousel-caption">
                            <h2>Tableaux Kanban</h2>
                            <p>Visualisez et gérez vos tâches avec des tableaux Kanban intuitifs et personnalisables.</p>
                        </div>
                    </div>
                    <!-- Slide 3 -->
                    <div class="carousel-item">
                        <img src="img/sprint-planning.jpg" class="d-block w-100" alt="Planification de Sprint" style="height: 400px;">
                        <div class="carousel-caption">
                            <h2>Planification de Sprint</h2>
                            <p>Planifiez vos sprints avec précision pour maximiser la productivité et la livraison de valeur.</p>
                        </div>
                    </div>
                    <!-- Slide 4 -->
                    <div class="carousel-item">
                        <img src="img/retrospective.jpg" class="d-block w-100" alt="Rétrospective Agile" style="height: 400px;">
                        <div class="carousel-caption">
                            <h2>Rétrospectives</h2>
                            <p>Améliorez continuellement vos processus grâce à des rétrospectives structurées et efficaces.</p>
                        </div>
                    </div>
                </div>
...
<section class="container mt-5">
    <div class="section-header">
        <h4 class="h4-gradient">Notre Processus Agile</h4>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Planification du Sprint</p>
                    <p class="card-text">
                        Définissez les objectifs du sprint, priorisez les tâches et assignez-les à votre équipe.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Exécution du Sprint</p>
                    <p class="card-text">
                        Suivez l'avancement des tâches en temps réel avec des tableaux Kanban et des outils de collaboration.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Revue et Rétrospective</p>
                    <p class="card-text">
                        Analysez les résultats du sprint, recueillez des retours et améliorez vos processus pour le prochain cycle.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item active">
          <div class="cards-wrapper d-flex justify-content-center">
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Gestion des Sprints</h3>
                <p class="card-text">Planifiez, exécutez et analysez vos sprints avec précision.</p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Gestion des Équipes et des Rôles</h3>
                <p class="card-text">Organisez vos équipes et attribuez des rôles avec précision.</p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Modèles de Projets Réutilisables</h3>
                <p class="card-text">Gagnez du temps avec des modèles de projets préconfigurés.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="cards-wrapper d-flex justify-content-center">
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Tableaux Kanban Personnalisés</h3>
                <p class="card-text">Visualisez et organisez vos tâches avec des tableaux Kanban flexibles et intuitifs.</p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Suivi des Tâches et des Échéances</h3>
                <p class="card-text">Ne perdez plus jamais de vue une échéance ou une tâche critique.</p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Sécurité et Confidentialité</h3>
                <p class="card-text">Protégez vos données avec des fonctionnalités de sécurité avancées.</p>
