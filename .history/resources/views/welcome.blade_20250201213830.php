        ...
        <div class="d-flex">
          ...
          <div>
            ...
            <p style="font-family:  Georgia, serif; text-align: justify;">Au Cabinet Médical <span class="font-weight-bold" style="color:#e16db3;"></h4>Health Care</h4></span>,
              La gestion de projet Agile est bien plus qu'une méthodologie : c'est une philosophie qui redéfinit la manière dont les équipes innovent et collaborent. En combinant flexibilité, transparence et livraison rapide, Agile permet de transformer des idées ambitieuses en résultats tangibles, sprint après sprint. Que vous cherchiez à accélérer votre time-to-market, à améliorer la qualité de vos produits ou à renforcer la collaboration au sein de votre équipe, Agile offre les outils et les pratiques pour y parvenir. Découvrez comment notre approche Agile sur mesure peut propulser vos projets vers le succès, en alignant stratégie, équipe et résultats.
            </p>
          </div>
        </div>
      </div>
