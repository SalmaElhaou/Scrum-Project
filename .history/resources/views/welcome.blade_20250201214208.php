        ...
        <div class="d-flex">
          ...
          <div>
            ...
            <p style="font-family:  Georgia, serif; text-align: justify;">Au Cabinet Médical <span class="font-weight-bold" style="color:#e16db3;"></h4>Health Care</h4></span>,
              GPA (Gestion de Projet Agile) : la clé pour des projets innovants, flexibles et efficaces. Avec des cycles de livraison rapides, une collaboration renforcée et une adaptation continue, GPA transforme vos défis en succès. Découvrez comment notre approche Agile sur mesure peut propulser vos résultats.
            </p>
          </div>
        </div>
      </div>
