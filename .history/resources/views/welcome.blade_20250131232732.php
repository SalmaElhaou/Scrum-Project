        ...
        <div class="d-flex">
          ...
          <div>
            ...
            <p style="font-family:  Georgia, serif; text-align: justify;">Au Cabinet Médical <span class="font-weight-bold" style="color:#e16db3;"></h4>Health Care</h4></span>,
              votre santé est notre priorité. Nous sommes dévoués à fournir des soins médicaux de haute qualité dans un environnement
              accueillant et chaleureux. Notre équipe de professionnels qualifiés est là pour répondre à vos besoins médicaux et vous
              offrir un soutien personnalisé à chaque étape de votre parcours vers la santé. Chez nous, vous trouverez des installations
              modernes et des services axés sur le bien-être de nos patients. Nous nous engageons à vous offrir des soins attentifs et attentionnés
              pour vous aider à maintenir une vie saine et épanouissante.</p>
          </div>
        </div>
      </div>
...
<section id="serviceSliderSection" class="container py-5 ">
  <div class="row">
    <!-- Titre -->
