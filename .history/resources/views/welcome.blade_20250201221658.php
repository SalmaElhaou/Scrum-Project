        ...
        <div class="carousel-item active">
          <div class="cards-wrapper d-flex justify-content-center">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h4 class="card-title">Gestion des Équipes et des Rôles</h4>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h4 class="card-title">Modèles de Projets Réutilisables</h4>
        ...
        <div class="carousel-item">
          <div class="cards-wrapper d-flex justify-content-center">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Tableaux Kanban Personnalisés</h5>
