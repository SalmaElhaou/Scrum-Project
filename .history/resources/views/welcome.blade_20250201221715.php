        ...
        <div class="carousel-item">
          <div class="cards-wrapper d-flex justify-content-center">
            <div class="card">
              ...
              <div class="card-body">
                <h3 class="card-title">Tableaux Kanban Personnalisés</h5>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Suivi des Tâches et des Échéances</h5>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Sécurité et Confidentialité</h5>
